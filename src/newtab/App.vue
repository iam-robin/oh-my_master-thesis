    ...
    <div class="info-container">
      ...
      <main>
        ...
        <div class="date">
          ...
          <svg v-if="activeMode === 'views'" width="16" height="16" viewBox="0 0 16 16">
            <g>
          ...
          <svg v-if="activeMode === 'clicks'" width="16" height="16" version="1.1" viewBox="0 0 16 16">
          ...
          <svg v-if="activeMode === 'scroll'" width="16" height="16" version="1.1" viewBox="0 0 16 16" >
            <g transform="scale(0.666667)">
